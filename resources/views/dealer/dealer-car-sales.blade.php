...
<div class="container">
    ...
    <div class="row justify-content-center mt-3 mb-3">
        <a class="text-center mb-3" href="{{ url('/dealer/dashboard/car-sales/track-car-sales') }}"><button class="btn btn-outline-success me-2" type="button">2ND Tracking Sales this in the deafult</button></a>
