...
class PurchaseModelPartController extends Controller
{
    ...
    {
        $manufacturerId = Auth::id();
        $query = PurchaseModelParts::where('manufacturer_id', $manufacturerId);
        ...
        $purchasedModelParts = $query->paginate(5);
    
        return view('manufacturer.purchased-model-parts', compact('purchasedModelParts'));
    }
